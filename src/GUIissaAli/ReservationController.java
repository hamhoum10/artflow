    ...
    public void initialize(URL url, ResourceBundle rb) {
      ...
      // r.setClient(ci.fetchClientByName(client.getValue().toString()));
       nb_place.getText();
        ...
        ci.fetchClient().stream().forEach(e->list.add(e.getFirstname()));
...
//        r.setDateres(java.sql.Date.valueOf(date));
      ...
      e.setId(ListeReservationController.id_event);
      String nb1=nb_place.getText();
      int nb2=  Integer.valueOf(nb1);
      
      r.setEvent(e);
      r.setNb_place(nb2);
      r.setClient(ci.getClientbyusername(LoginFXMLController.usernamewelcome));// valeur static de login issu de nada
             System.out.println("///////////////////////////");
             System.out.println(LoginFXMLController.usernamewelcome);
             System.out.println("///////////////////////////");
             // e.setArtiste(as.fetchArtisteById(19));
      Rs.addReservation(r);
     // totalprix.setText(String.valueOf((Rs.totalMontalReservation(23)))); // valeur static de login issu de nada
