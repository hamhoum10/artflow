...
//            prix.setText(e.getPrix().toString());
     ...
     //  ArtisteSerice Z = new ArtisteSerice();
       ...
       ClientService cs = new ClientService();
        ...
        try {
           ...
           r.setDate_evemt(java.sql.Date.valueOf(date));
           // e.setDate(date.getText());
            r.setStart_hour(start_hour.getText());
            r.setFinish_hour(finish_hour.getText());
            r.setCapacity(capacity.getText());
            r.setDescription(description.getText());
            r.setImage(imagee.getText());
            r.setLocation(location.getText());
            r.setPrix(Double.parseDouble(prix.getText()));
            P.setId(cs.getidclientbyusername(LoginArtisteController.usernameArtiste));
           //e.setId_artiste(P); 
           //e.setId_artiste(1);
    ...
    private void artiste(ActionEvent event) {
        r.setArtiste(ci.getArtistebyusername(LoginArtisteController.usernameArtiste));
    }
